        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center gap-3">
              <button
                onClick={() => router.back()}
                className="p-2 rounded-md text-gray-400 hover:text-gray-600 focus:outline-none transition-colors"
                aria-label="Go back"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="rounded-xl overflow-hidden mb-6">
              <div className="relative h-96 bg-gradient-to-br from-gray-100 to-gray-200">
                ...
                <button
                  onClick={() => setIsFavorite(!isFavorite)}
                  className="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full p-3 shadow-lg hover:scale-110 transition-transform duration-200"
                >
                  <svg
                    className={`w-6 h-6 ${isFavorite ? 'text-red-500 fill-current' : 'text-gray-600'}`}
                    fill={isFavorite ? "currentColor" : "none"}
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 sticky top-24 border border-gray-100">
              <h3 className="text-lg font-semibold mb-4 text-gray-900">Contact {property.agent ? 'Agent' : 'Landlord'}</h3>
              
              {/* Agent/Landlord Info */}
              <div className="flex items-center mb-4">
                <div className="w-12 h-12 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center text-white font-semibold mr-3 shadow-lg">
                  {contactPerson.firstName.charAt(0)}{contactPerson.lastName.charAt(0)}
                </div>
                <div>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 rounded-lg hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 font-medium shadow-lg hover:shadow-xl transform hover:-translate-y-0.5"
                >
                  Book Now
                </button>
                <button
                  onClick={handleRequestViewing}
                  className="w-full border-2 border-indigo-600 text-indigo-600 py-3 rounded-lg hover:bg-indigo-50 transition-all duration-200 font-medium hover:border-indigo-700 hover:text-indigo-700"
                >
                  Request Viewing
                </button>
                <button
              ...
              {/* Quick Info */}
              <div className="mt-6 pt-6 border-t border-gray-200">
                <div className="flex justify-between text-sm text-gray-600 mb-2 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                  <span>Property Type:</span>
                  <span className="font-medium capitalize text-gray-900">{property.type}</span>
                </div>
                <div className="flex justify-between text-sm text-gray-600 mb-2 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                  <span>Availability:</span>
                ...
                <div className="flex justify-between text-sm text-gray-600 p-2 rounded-lg hover:bg-gray-50 transition-colors">
                  <span>Status:</span>
                  <span className={`font-medium capitalize ${
                    property.status === 'available' ? 'text-green-600' : 'text-red-600'
                  }`}>
